...
public abstract class WorldProvider
{
    ...
    public static WorldProvider getProviderForDimension(int par0)
    {
        ...
        if (DimensionAPI.dimensionMap.containsValue(Integer.valueOf(par0)))
        {
            WorldProviderBase worldproviderbase = (WorldProviderBase)DimensionAPI.getProviderByDimension(par0);
            minecraft.renderGlobal = worldproviderbase.getGlobalRenderer(minecraft, minecraft.renderEngine);
            return worldproviderbase;
        }
        else
        {
            return null;
