...
public final class ItemStack
{
    ...
    public boolean useItem(EntityPlayer par1EntityPlayer, World par2World, int par3, int par4, int par5, int par6)
    {
        ...
        if (DimensionAPI.itemUseMap.containsKey(Integer.valueOf(itemID)))
        {
            par1EntityPlayer.addStat(StatList.objectUseStats[itemID], 1);
            IItemUse iitemuse = (IItemUse)DimensionAPI.itemUseMap.get(Integer.valueOf(itemID));
            iitemuse.onItemUse(this, par1EntityPlayer, par2World, par3, par4, par5, par6);
            return true;
        }
    ...
    {
        if (DimensionAPI.itemRightClickMap.containsKey(Integer.valueOf(itemID)))
        {
            IItemRightClick iitemrightclick = (IItemRightClick)DimensionAPI.itemRightClickMap.get(Integer.valueOf(itemID));
            return iitemrightclick.onItemRightClick(this, par1World, par2EntityPlayer);
        }
        else
        {
